...
function SignupForm() {
  ...
  async function handleEmailSignUp(e: React.FormEvent) {
    ...
    const { error: signUpError } = await supabase.auth.signUp({
      email,
      password: "", // magic link sign-up doesn't need a password
      options: {
    ...
    if (signUpError) {
      ...
      setMessage(
        "Check your email for a confirmation link. You'll be signed in automatically."
      );
    }
    setLoading(false);
  }
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      ...
      <p className="mt-2 text-sm opacity-70">
        Staff, teachers and programme partners use this to sign up.
        Participants who received an access code should sign in via the access
        code page instead.
      </p>
      ...
      <div className="mt-8 space-y-6">
        ...
        <form onSubmit={handleEmailSignUp}>
          ...
          <button
            ...
            className="mt-6 w-full rounded-theme bg-primary px-5 py-4 font-medium text-primary-contrast hover:opacity-90 focus-visible:ring-2 disabled:opacity-50"
          >
